 ...
 * \defgroup packetsink MeshSimPacketSink
 *
 * This application was written to complement OnOffApplication, but it
 * is more general so a MeshSimPacketSink name was selected.  Functionally it is
 ...
 */
class MeshSimPacketSink : public Application
{
public:
  /**
