 ...
 * \defgroup onoff MeshSimOnOffApplication
 *
...
*/
class MeshSimOnOffApplication : public Application
{
public:
  /**
  ...
  MeshSimOnOffApplication ();

  virtual ~MeshSimOnOffApplication();
...
private:
  ...
  uint64_t        m_seqNumber;    //!< Sequence number of next packet
