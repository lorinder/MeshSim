 ...
 * \defgroup bulksend MeshSimBulkSendApplication
 *
 ...
 *
 */
class MeshSimBulkSendApplication : public Application
{
public:
  /**
  ...
  MeshSimBulkSendApplication ();

  virtual ~MeshSimBulkSendApplication ();
